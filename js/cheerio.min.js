...
function B(e) {
    ...
    for (; null !== (t = P.exec(e));) {
        const i = t.index,
            s = e.charCodeAt(i),
            a = x.get(s);
        void 0 !== a ? (n += e.substring(r, i) + a, r = i + 1) : (n += `${e.substring(r,i)}&#x${w(e,i).toString(16)};`, r = P.lastIndex += Number(55296 == (64512 & s)))
    }
    return n + e.substr(r)
}
...
class tc {
    ...
    _stateScriptDataLessThanSign(e) {
        switch (e) {
            ...
            case io.EXCLAMATION_MARK:
                ...
                break;
            default:
                this._emitChars("<"), this.state = Ko.SCRIPT_DATA, this._stateScriptData(e)
        }
    }
    _stateScriptDataEndTagOpen(e) {
        Qo(e) ? (this.state = Ko.SCRIPT_DATA_END_TAG_NAME, this._stateScriptDataEndTagName(e)) : (this._emitChars("</"), this.state = Ko.SCRIPT_DATA, this._stateScriptData(e))
    }
    _stateScriptDataEndTagName(e) {
        this.handleSpecialEndTag(e) && (this._emitChars("</"), this.state = Ko.SCRIPT_DATA, this._stateScriptData(e))
    }
    _stateScriptDataEscapeStart(e) {
        e === io.HYPHEN_MINUS ? (this.state = Ko.SCRIPT_DATA_ESCAPE_START_DASH, this._emitChars("-")) : (this.state = Ko.SCRIPT_DATA, this._stateScriptData(e))
    }
    _stateScriptDataEscapeStartDash(e) {
        e === io.HYPHEN_MINUS ? (this.state = Ko.SCRIPT_DATA_ESCAPED_DASH_DASH, this._emitChars("-")) : (this.state = Ko.SCRIPT_DATA, this._stateScriptData(e))
    }
    _stateScriptDataEscaped(e) {
        switch (e) {
            case io.HYPHEN_MINUS:
                this.state = Ko.SCRIPT_DATA_ESCAPED_DASH, this._emitChars("-");
                break;
            case io.LESS_THAN_SIGN:
    ...
    _stateScriptDataEscapedDash(e) {
        switch (e) {
            case io.HYPHEN_MINUS:
                this.state = Ko.SCRIPT_DATA_ESCAPED_DASH_DASH, this._emitChars("-");
                break;
            case io.LESS_THAN_SIGN:
                this.state = Ko.SCRIPT_DATA_ESCAPED_LESS_THAN_SIGN;
                break;
    ...
    function r(e) {
        for (var r, i = "", s = 0; null !== (r = t.xmlReplacer.exec(e));) {
            var a = r.index,
                o = e.charCodeAt(a),
                c = n.get(o);
            void 0 !== c ? (i += e.substring(s, a) + c, s = a + 1) : (i += "".concat(e.substring(s, a), "&#x").concat((0, t.getCodePoint)(e, a).toString(16), ";"), s = t.xmlReplacer.lastIndex += Number(55296 == (64512 & o)))
        }
        return i + e.substr(s)
    }
